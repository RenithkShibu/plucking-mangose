...
function setup() {
   ...
   ground=new Ground(800,600,1600,15)
    ...
    boy=new Boy(370,485,150,220)
  
   stoneobj=new Stone(300,450,25)

   rope=new Target(stoneobj.body,{x:300,y:440})

   tree=new Tree(1200,400,450,400)

   mango1=new Mango(1400,310,70)
   mango2=new Mango(1300,340,70)
   mango3=new Mango(1310,270,70)
   mango4=new Mango(1200,320,70)
   mango5=new Mango(1110,350,70)
